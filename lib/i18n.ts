...
const en = {
  ...
  // figures
  figureStatus: { rising: "rising", stable: "stable", declining: "declining", dead: "dead", unknown: "unknown" } as Record<FigureStatus, string>,
  ours: "Ours",
  here: "Here",
  figuresEmpty:
  ...
  tier: { 1: "Marginal", 2: "Minor power", 3: "Regional power", 4: "Major power", 5: "Hegemon" } as Record<number, string>,
...
const ko: Strings = {
  ...
  figureStatus: { rising: "상승", stable: "안정", declining: "쇠퇴", dead: "사망", unknown: "불명" },
  ours: "실제",
  here: "여기",
  figuresEmpty: "시나리오를 움직이는 인물들을 여기서 추적합니다: 누구인지, 실제 세계에서 어떻게 되었는지, 이 세계에서는 어떻게 되어 가는지.",
  rename: "이름 바꾸기",
  editName: "이름 편집",
  posture: { expanding: "팽창", emerging: "부상", consolidating: "공고화", defensive: "수세", fracturing: "분열", collapsing: "붕괴" },
  relation: { ally: "동맹", trade: "교역", neutral: "중립", vassal: "속국", rival: "경쟁", war: "전쟁" },
  tier: { 1: "미미한 세력", 2: "약소 세력", 3: "지역 강국", 4: "강대국", 5: "패권국" },
  strength: (n) => `국력 ${n}/5`,
  interests: "전략적 이해관계",
